...
const buttonVariants = cva(
  ...
  {
    variants: {
      // NOTE:Podemos cambiar los colores de los botones si lo vemos necesario
      variant: {
        default:
          "bg-white text-black border-slate-200 border-2 border-b-[4px] active:border-b-2 hover:bg-slate-100 text-slate-500",
        primary:
          "bg-violet-500 text-primary-foreground hover:bg-violet-500/90 border-violet-800 border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-violet-500 hover:bg-slate-100",
        secondary:
          "bg-sky-500 text-primary-foreground hover:bg-sky-500/90 border-sky-700 border-b-4 active:border-b-0",
        ...
        super:
          "bg-purple-500 text-primary-foreground hover:bg-purple-500/90 border-purple-700 border-b-4 active:border-b-0",
        ...
        sidebarOutline:
          "bg-violet-600/15 text-violet-600 border-violet-300 border-2 hover:bg-violet-600/2 transition-none",
      },
      size: {
